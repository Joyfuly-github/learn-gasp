...
onMounted(() => {
  ...
  ScrollTrigger.create({
    ...
    // onEnter: () => {
    //   gsap.to(navRef.value, { padding: '10px', duration: 0.3, ease: 'power2.out' })
    //   gsap.to(navRef.value.querySelector('ul'), { gap: '10px', duration: 0.3, ease: 'power2.out' })
    // },
    // onLeaveBack: () => {
    //   gsap.to(navRef.value, { padding: '20px', duration: 0.3, ease: 'power2.out' })
    //   gsap.to(navRef.value.querySelector('ul'), { gap: '20px', duration: 0.3, ease: 'power2.out' })
    // },
  })
})
</script>
...
.parallax__nav.scroll {
  padding: 10px;
}

.parallax__nav.scroll > ul {
  gap: 10px;
}
