...
onMounted(() => {
  ...
  //   },
  // })
  // bg.to('html, body', { '--bg-color': 'red' })
  //   .to('html, body', { '--bg-color': 'green' })
  //   .to('html, body', { '--bg-color': 'blue' })

  // 02 섹션 별로 전체 배경 변경하기
  gsap.utils.toArray(sectionsRefs.value).forEach((el) => {
    ...
    ScrollTrigger.create({
      ...
      onEnter: () => {
        gsap.to('html, body', { '--bg-color': color, duration: 1.4 })
      },
